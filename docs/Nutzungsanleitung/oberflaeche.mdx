...
| ![](./img/meine_metadaten.png)                                                                   | Meine Metadaten               | Nutzende haben bereits an diesem Datensatz gearbeitet und sind damit im Team der Bearbeitenden. Damit kann der Datensatz ihnen direkt zugewiesen werden (siehe [Zuweisen](#zuweisen) von Datensätzen) |
...
| ![](./img/zuweisen.png)       | Ermöglicht das [Zuweisen](#zuweisen) des Metadatensatzes zu einer Rolle oder auch einr bestimmten nutzenden Person. Im Falle der QS kann hier auch der Metadatensatz als geprüft markiert werden.                                         |
